...
const successStories = [
    {
        ...
        image:
            "https://i.ibb.co/zWrkqfSk/photo-1516534775068-ba3e7458af70-q-80-w-1170-auto-format-fit-crop-ixlib-rb-4-1.jpg",
    },
    {
        name: "Tariq Hasan",
        ...
        image:
            "https://i.ibb.co/pBbTxxzz/photo-1495995424756-6a5a3f9e7543-q-80-w-1176-auto-format-fit-crop-ixlib-rb-4-1.jpg",
    },
    {
        ...
        image:
            "https://i.ibb.co/cRw86xQ/photo-1514355315815-2b64b0216b14-q-80-w-1170-auto-format-fit-crop-ixlib-rb-4-1.jpg",
    },
];
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {successStories.map((story, index) => (
                    <motion.div
                        ...
                        className="bg-base-100 p-6 rounded-2xl shadow-md hover:shadow-xl transition-shadow border border-base-300"
                    >
                        {/* User info */}
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-neutral text-sm">{story.field}</p>
                            </div>
                        </div>

                        {/* Testimonial */}
                        <div className="text-neutral relative text-sm">
                            <FaQuoteLeft className="text-accent absolute -top-2 -left-2" />
